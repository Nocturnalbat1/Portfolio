...
#1. Deal out deck of 20 cards between two users.
#2. Each player plays a card at random. Higher card wins. Winner gets a point.
#3. If the players tie then no point is awarded but the cards are used.
#4. The game is over when there are no cards left in the deck.
...
def main():
    ...
    if pOneScore > pTwoScore:
        ...
        winner = 'It was a tie'
    print("The final score is: {pOneScore} to {pTwoScore}, {winner}")
